...
const MaterialColor mainColor = Colors.deepOrange;
const Color statusBarColor = Color(0xffff9900);
const Color destext = Color(0xff6132e4);
const Color darkGreyClr = Color(0xFF121212);
const Color carticoncolor = Color(0xffdf5862);
